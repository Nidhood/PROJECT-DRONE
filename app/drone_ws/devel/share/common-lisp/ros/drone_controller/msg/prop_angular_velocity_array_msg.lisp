...
(cl:defclass <prop_angular_velocity_array_msg> (roslisp-msg-protocol:ros-message)
  ((props
    :reader props
    :initarg :props
    :type (cl:vector drone_controller-msg:prop_angular_velocity_msg)
   :initform (cl:make-array 0 :element-type 'drone_controller-msg:prop_angular_velocity_msg :initial-element (cl:make-instance 'drone_controller-msg:prop_angular_velocity_msg))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <prop_angular_velocity_array_msg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'prop_angular_velocity_array_msg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name drone_controller-msg:<prop_angular_velocity_array_msg> is deprecated: use drone_controller-msg:prop_angular_velocity_array_msg instead.")))

(cl:ensure-generic-function 'props-val :lambda-list '(m))
(cl:defmethod props-val ((m <prop_angular_velocity_array_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader drone_controller-msg:props-val is deprecated.  Use drone_controller-msg:props instead.")
  (props m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <prop_angular_velocity_array_msg>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'props)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'drone_controller-msg:prop_angular_velocity_msg))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<prop_angular_velocity_array_msg>)))
  ...
  "drone_controller/prop_angular_velocity_array_msg")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'prop_angular_velocity_array_msg)))
  "Returns string type for a message object of type 'prop_angular_velocity_array_msg"
  "drone_controller/prop_angular_velocity_array_msg")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<prop_angular_velocity_array_msg>)))
  ...
  (cl:format cl:nil "prop_angular_velocity_msg[] props~%~%================================================================================~%MSG: drone_controller/prop_angular_velocity_msg~%string prop_name~%float64 angular_velocity~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'prop_angular_velocity_array_msg)))
  "Returns full string definition for message of type 'prop_angular_velocity_array_msg"
  (cl:format cl:nil "prop_angular_velocity_msg[] props~%~%================================================================================~%MSG: drone_controller/prop_angular_velocity_msg~%string prop_name~%float64 angular_velocity~%~%"))
