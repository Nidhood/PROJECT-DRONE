...
PROJECT_PKG_CONFIG_INCLUDE_DIRS = "/app/drone_ws/src/hector_quadrotor_controller/include".split(';') if "/app/drone_ws/src/hector_quadrotor_controller/include" != "" else []
