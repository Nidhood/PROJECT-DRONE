...
PROJECT_PKG_CONFIG_INCLUDE_DIRS = "/app/drone_ws/src/hector_quadrotor_model/include;/usr/include".split(';') if "/app/drone_ws/src/hector_quadrotor_model/include;/usr/include" != "" else []
...
PROJECT_SPACE_DIR = "/app/drone_ws/devel"
